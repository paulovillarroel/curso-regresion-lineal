...
Pensándolo con una analogía: diagnosticar supuestos es como revisar que el motor de un auto funciona bien. Pero si te subiste al auto equivocado, de nada sirve que el motor esté perfecto. La identificación causal — decidir qué variables incluir y por qué — es elegir el auto correcto. Para una guía práctica sobre cómo tomar esas decisiones, ver @huntingtonklein2021.
:::
...
Si pierdes más del 5–10% de los datos, investiga **por qué** faltan antes de continuar. La calidad del registro institucional condiciona todo lo que sigue: ningún test de supuestos puede corregir un sesgo de selección introducido por datos faltantes no aleatorios.
:::
