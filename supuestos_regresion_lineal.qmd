...
Si quieres usar `diagnostico_ols()` y `plot_diagnostico_ols()` en tus propios proyectos sin copiar el código, puedes instalarlas directamente como un paquete de R desde el repositorio de este curso:
